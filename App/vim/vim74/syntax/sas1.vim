...
if version >= 508 || !exists("did_sas_syntax_inits")
   ...
   " Default sas enhanced editor color syntax
	...
	hi sText	term=NONE cterm=NONE ctermfg=NONE ctermbg=Black gui=bold guifg=Black guibg=NONE
	...
	hi mDefine	term=NONE cterm=bold ctermfg=NONE ctermbg=Black gui=bold guifg=Black guibg=NONE
	hi mKeyword	term=NONE cterm=NONE ctermfg=Blue ctermbg=Black gui=NONE guifg=Blue guibg=NONE
	hi mReference	term=NONE cterm=bold ctermfg=NONE ctermbg=Black gui=bold guifg=Blue guibg=NONE
	hi mSection	term=NONE cterm=NONE ctermfg=Blue ctermbg=Black gui=bold guifg=Navy guibg=NONE
	hi mText	term=NONE cterm=NONE ctermfg=NONE ctermbg=Black gui=bold guifg=Black guibg=NONE

" Colors that closely match SAS log colors for default color scheme
	hi lError	term=NONE cterm=NONE ctermfg=Red ctermbg=Black gui=none guifg=Red guibg=NONE
	hi lWarning	term=NONE cterm=NONE ctermfg=Green ctermbg=Black gui=none guifg=Green guibg=NONE
	hi lNote	term=NONE cterm=NONE ctermfg=Cyan ctermbg=Black gui=none guifg=Blue guibg=NONE
