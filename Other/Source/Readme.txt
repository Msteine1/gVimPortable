...
user in an INI file next to gVimPortable.exe called gVimPortable.ini.
...
copy AppNamePortable.ini from this directory to gVimPortable.ini next to
gVimPortable.exe. The options in the INI file are as follows:
